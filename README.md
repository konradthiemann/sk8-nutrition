...
Progressive Web App für den Ernährungs-Teil des SK8-Projekts: Mahlzeiten von heute, Hydration und Etiketten-Scan auf dem Weg zum Contest am 18. September 2027 in Braunschweig.
...
| Befehl | Zweck |
|---|---|
| `pnpm dev` | Entwicklungsserver auf Port 5174 |
...
```sh
docker build --build-arg VITE_API_URL=http://localhost:8000 --build-arg VITE_API_KEY=dev-key-change-me -t sk8-nutrition .
docker run --rm -p 8080:80 sk8-nutrition
```
